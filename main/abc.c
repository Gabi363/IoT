...
// #define REMOTE_SERVICE_UUID        0x180F //iTAG battery service
// #define REMOTE_NOTIFY_CHAR_UUID    0x2A19 //battery level characteristic
// #define PROFILE_NUM      1
// #define PROFILE_A_APP_ID 0
// #define INVALID_HANDLE   0

// //static const char remote_device_name[] = "ESP_GATTS_DEMO";
// static const char remote_device_name[] = "iTAG"; //borch
...
//             }
//             ESP_LOGI(GATTC_TAG, "attr count: %d\n",count);
//             if (count > 0){
...
//                         ESP_LOGI(GATTC_TAG, "char count: %d\n",count);
...
//                 ESP_LOGE(GATTC_TAG, "esp_ble_gattc_get_attr_count error");
//             }
//             ESP_LOGI(GATTC_TAG, "desc count: %d\n",count);
//             if (count > 0){
...
//                 char adv_name_nospaces[strlen(remote_device_name)];

//                 int i,j;	
//                 for ( i = 0, j = 0; i<strlen((const char*)adv_name);i++,j++) {
//                     if (adv_name[i] != ' ')  
//                         adv_name_nospaces[j]=adv_name[i];
//                     else 
//                         j--;
//                 }
//                 adv_name_nospaces[j]=0;

//                 ESP_LOGI(GATTC_TAG, "remote_device_name: %s | remote_device_name len: %d\n", remote_device_name,strlen(remote_device_name));
//                 ESP_LOGI(GATTC_TAG, "adv_name_nospaces: %s | adv_name_nospaces len: %d\n", adv_name_nospaces,strlen(adv_name_nospaces));

//                 //if (strlen(remote_device_name) == adv_name_len && strncmp((char *)adv_name, remote_device_name, adv_name_len) == 0) { 
                
//                 if ( strncmp(adv_name_nospaces, remote_device_name, strlen(adv_name_nospaces)) == 0 ) { 
